...
class TestJoinConsultation:
    ...
    @pytest.mark.dependency(name="join_button_clickable")
    def test_join_button_clickable(self):
        ...
        assert self.ca.is_action_clickable(self.index)

    @pytest.mark.dependency(name="join_button_not_visible")
    ...
    @pytest.mark.dependency(
        name="start_now_visible",
        depends=["join_button_clickable"]
    )
    ...
    def test_click_start_now_button_opens_zoom(self):
        ...
        assert self.ca.is_url_contains(
            get_value(
