...
class Testsuperadmin:
    ...
    @pytest.mark.parametrize(
        "medicalname,composition,minlevel,reorderlevel,tax,vatac,racknumber,boxpacking,note",
        excelreader.get_data("medicallist.xlsx", "Sheet1")
    )
